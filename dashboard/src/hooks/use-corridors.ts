  ...
  for (const c of corridors) {
    ...
    if (c.depotA.isActive) {
      routes.push({
        ...
        inputTypeId: c.depotA.inputItem.typeId,
        outputTypeId: c.depotA.outputItem.typeId,
        sourceGateId: c.sourceGate.id,
        destGateId: c.destGate.id,
        depotId: c.depotA.id,
    ...
    if (c.depotB.isActive) {
      routes.push({
        ...
        inputTypeId: c.depotB.inputItem.typeId,
        outputTypeId: c.depotB.outputItem.typeId,
        sourceGateId: c.destGate.id,
        destGateId: c.sourceGate.id,
        depotId: c.depotB.id,
